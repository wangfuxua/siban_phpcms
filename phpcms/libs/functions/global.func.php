 ...
 */
 function mypages($num, $curr_page, $perpage = 20, $urlrule = '', $array = array(),$setpages = 10) {
	...
	if($num > $perpage) {
		...
		/* <li class="w70"><a class="" href="#">上一页</a></li>
		<li class="current"><a href="#">1</a></li>
		<li><a href="#">2</a></li>
		<li><a href="#">3</a></li>
		<li><a href="#">4</a></li>
		<li class="w70"><a href="#">下一页</a></li>
		<li class="w50">共4页</li>
		<li class="w60">到<input type="text" id="pageinput">页</li>
		<li><a href="javascript:void(0)">GO</a></li> */
		
		
		if($curr_page>0) {
			$multipage .= '<li class="w70"> <a href="'.pageurl($urlrule, $curr_page-1, $array).'">'.L('previous').'</a></li>';
			if($curr_page==1) {
				$multipage .= ' <li class="current"><a href="javascript:void(0)">1</a></li>';
			} elseif($curr_page>6 && $more) {
		...
		for($i = $from; $i <= $to; $i++) {
			if($i != $curr_page) {
				...
				$multipage .= '<li class="current"><a href="javascript:void(0)">'.$i.'</a></li>';
			}
		}
		if($curr_page<$pages) {
			if($curr_page<$pages-5 && $more) {
				$multipage .= ' ..<li><a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a></li> 
				<li class="w70"><a href="'.pageurl($urlrule, $curr_page+1, $array).'" >'.L('next').'</a></li>';
			} else {
				$multipage .= ' <li><a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a></li> 
				<li class="w70"><a href="'.pageurl($urlrule, $curr_page+1, $array).'">'.L('next').'</a></li>';
			}
		} elseif($curr_page==$pages) {
			$multipage .= '<li class="current"> <a href="javascript:void(0)">'.$pages.'</a></li> 
			<li class="w70"><a href="'.pageurl($urlrule, $curr_page, $array).'" >'.L('next').'</a></li>';
		} else {
			$multipage .= '<li> <a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a></li><li class="w70"> <a href="'.pageurl($urlrule, $curr_page+1, $array).'">'.L('next').'</a></li>';
		}
		$multipage .= '<li class="w50">共'.$num.L('page_item').'</li>';
	}
	return $multipage;
}
/**
