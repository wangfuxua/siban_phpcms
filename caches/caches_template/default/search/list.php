	...
	<div class="main2">
		...
		<div class="main2_left">
			...
			<div class="search_menu">
				...
				<p>类别：
					<a  href="index.php?m=search&c=index&a=init&typeid=0&q=<?php echo urlencode($search_q);?>&siteid=<?php echo $siteid;?>&time=<?php echo $time;?>" <?php if($_GET['typeid']==0) { ?> class="current"<?php } ?>>不限</a>
