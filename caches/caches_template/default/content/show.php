...
<body>
	...
	<div class="main2">
		...
		<div class="main2_left">
			...
			<div class="content_box">
				...
				<span>来源：<?php echo $copyfrom;?>&nbsp;&nbsp;作者：四板财经&nbsp;&nbsp;  时间：<?php echo $inputtime;?></span>
				<?php echo $content;?>    
			</div>
			
			<div id="pages" class="submenu">
				<ul style="width:200px"><?php echo $pages;?></ul>
			</div>

			<div class="relative_box">
			
				<p><a href="<?php echo $previous_page['url'];?>">上一篇：<?php echo $previous_page['title'];?></a></p>
				<p><a href="<?php echo $next_page['url'];?>">下一篇：<?php echo $next_page['title'];?></a></p>
				<p>关键词：<?php $n=1;if(is_array($keywords)) foreach($keywords AS $keyword) { ?><a href="<?php echo APP_PATH;?>index.php?m=content&c=tag&a=lists&tag=<?php echo urlencode($keyword);?>" class="blue"><?php echo $keyword;?></a><?php $n++;}unset($n); ?></p>
			</div>
	...
	<script type="text/javascript">
				var preg = /^([a-zA-z]+:\/\/)?([\w-]+\.)+[\w-]+(\/[\w- .\/?%&=]*)?$/;
				var suffix = /doc|docx/;
				var url = $('.content_box>a').attr("href");
				var url2 = $('.content_box p a').attr("href");
				if(preg.test(url))
				{
					if(suffix.test(url))
					{}
