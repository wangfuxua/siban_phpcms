...
<!--main-->
	...
	<div class="position_box">
		当前位置: <a href="<?php echo siteurl($siteid);?>">首页</a><span> &gt; </span><?php echo catpos($catid);?> 标签：<font color="red"><?php echo $tag;?></font> 总共有 <?php echo $total;?> 条记录</div>
	</div>
			...
			<div class="list_box">
				<ul>
					<?php $n=1;if(is_array($datas)) foreach($datas AS $r) { ?>
						<li><a href="<?php echo $r['url'];?>"<?php echo title_style($r[style]);?>><?php echo $r['title'];?></a> <span><?php echo date('Y-m-d',$r['inputtime']);?></span></li>
					<?php $n++;}unset($n); ?>
				</ul>
			</div>
